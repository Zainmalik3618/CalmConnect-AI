...
interface PsychiatristDashboardProps {
  ...
  unreadAppointmentsCount: number; // Patient-specific, but passed for prop consistency
...
const PsychiatristDashboard: React.FC<PsychiatristDashboardProps> = ({ 
    currentUser, 
    users, 
    onLogout, 
    onUpdateUser, 
  ...
  return (
    <div className="role-theme role-psychiatrist-theme flex flex-col min-h-screen font-sans antialiased text-gray-800 dark:text-gray-200">
      <Layout
