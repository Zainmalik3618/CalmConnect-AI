        ...
        <div className="max-w-6xl mx-auto space-y-8 p-4">
            ...
            {quote && (
                <motion.section 
                    ...
                    className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-violet-700 rounded-3xl p-8 text-white shadow-xl"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <motion.div 
                    ...
                    className="lg:col-span-1 bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center justify-between"
                >
                    <div className="space-y-4">
                        <div className="inline-flex items-center justify-center p-6 bg-orange-50 dark:bg-orange-900/30 rounded-full mb-4">
                            <Flame className={`w-16 h-16 ${stats?.streak.current_streak ? 'text-orange-600 dark:text-orange-400 animate-pulse' : 'text-gray-300 dark:text-gray-600'}`} />
                        </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        {stats?.earnedBadges.map((badge, idx) => (
                            <motion.div 
                                ...
                                className="bg-white dark:bg-gray-800 p-6 rounded-3xl border-2 border-indigo-50 dark:border-indigo-900/30 flex flex-col items-center text-center gap-3 hover:shadow-md transition-shadow"
                            >
                        ...
                        {Array.from({ length: Math.max(0, (stats?.availableBadgesCount || 5) - (stats?.earnedBadges.length || 0)) }).map((_, i) => (
                            <div key={`locked-${i}`} className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-3xl border-2 border-dashed border-gray-100 dark:border-gray-700 flex flex-col items-center text-center gap-3 opacity-60">
